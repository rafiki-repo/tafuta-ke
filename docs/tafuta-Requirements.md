...
- **Business tag (`business_tag`)**: each business has a human-readable slug (e.g., `daniels-salon`) used as the media folder name (tag is unique, no UUID suffix needed); separate from `subdomain`; see PRD-07
