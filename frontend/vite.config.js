...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Tafuta - Kenya Business Directory",
        short_name: "Tafuta",
        description: "Find local businesses and services in Kenya",
        theme_color: "#ED4C22",
  ...
  server: {
    ...
    proxy: {
      ...
      // Proxy media requests to the backend in development so /media/* URLs resolve
      "/media": {
        target: "http://localhost:3000",
        changeOrigin: true,
      },
